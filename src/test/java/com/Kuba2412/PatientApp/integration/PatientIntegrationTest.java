package com.Kuba2412.PatientApp.integration;

import com.Kuba2412.PatientApp.dto.VisitDTO;
import com.Kuba2412.PatientApp.service.PatientService;
...
public class PatientIntegrationTest {
    ...
    void getAvailableVisitsByDoctorId_Success() throws Exception {
        ...
        // When
        List<VisitDTO> result = patientService.getAvailableVisitsByDoctorId(2L);
    ...
    void getAvailableVisitsByDoctorId_ServiceUnavailable() {
        ...
        // When & Then
        assertThrows(RetryableException.class, () -> patientService.getAvailableVisitsByDoctorId(1L));
    }
}